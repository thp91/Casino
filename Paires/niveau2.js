//Affichage  4 images en paire   //
var paireimg = [1,2,3,4,1,2,3,4]

// random melanges des cartes//
...
if (cliquer.target.tagName == "IMG"&& cliquer.target != image1){
    ...
    setTimeout( function () { //Comparaisons des images//
        if (image1.src == image2.src ){
            ...
            score.textContent = "Bien jouées, toutes les paires sont trouvées passer au niveau suivant."
